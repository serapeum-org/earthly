...
=====================================================================
**earthly** is a Remote Sensing package
...
Installing `earthly` from the `conda-forge` channel can be achieved by:

```
conda install -c conda-forge earthly
```

It is possible to list all of the versions of `earthly` available on your platform with:
...
[other code samples](https://earthly.readthedocs.io/en/latest/?badge=latest)
